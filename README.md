...
项目先暂停两天，因为只剩支付功能还没有完成，但是支付对接方面目前还没有很好的思路，因为各家支付平台的对接方式都不尽相同。如果有好的建议，欢迎在 issue 中留言或者提交 PR，也可以加入群聊。
...
<img src="images/usdt_trc20.png" alt="USDT TRC20 收款码" width="300"/>
